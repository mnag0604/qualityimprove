...
if (isset($_POST["assign_training"])) {
    ...
    header("Location: assign_training.php");
}

// Handle Delete Training Assignment
...
if (isset($_POST["edit_training"])) {
    ...
    mysqli_query($conn, "UPDATE training SET training_name='$training_name', description='$description', 
                        assigned_to='$assigned_to', completion_status='$completion_status' WHERE training_id='$training_id'");
    header("Location: assign_training.php");
}
...
<head>
    ...
    <title>Assign Training - Quality Management</title>
...
<div class="m-header">
    ...
    <div class="container">
        <h2 class="text-center mb-4">Assign Training to Employees</h2>
        ...
        <div class="mb-4">
            <form method="POST" class="row g-3">
                ...
                <div class="col-md-3">
                    <button type="submit" name="assign_training" class="btn btn-success w-100">Assign Training</button>
                </div>
            </form>
        </div>
