...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM users WHERE email='$email' AND password_hash='$password' AND role='Manager'";
...
<head>
    ...
    <title>Manager Login - Quality Management</title>
    ...
    <div class="container">
        <div class="login-container">
            ...
            <form method="POST" action="">
                ...
                <a href="manager_register.php">Register Here</a>
            </form>
        </div>
    </div>
